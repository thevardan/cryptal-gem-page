class IPRedirectService {
    constructor() {
      this.vietnamRedirectUrl = atob('aHR0cDovL3pvODh3aW4udG9wP2E9ODdjNDA3ZjA5ZDljNDM3ZTZiOWZjODA2MzdhYjYxNzcmdXRtX3NvdXJjZT1pbmhvdXNlJnV0bV9tZWRpdW09dHJhZmZpYyZ1dG1fY2FtcGFpZ249dGlrdG9rJnV0bV9jb250ZW50PXRyYWZmaWMtdGlrdG9rYWRz');
      this.notFoundRedirectUrl = atob('aHR0cHM6Ly9iZWF1dGlmdWwtNDA0LXBhZ2Utdy1tNzBrLmJvbHQuaG9zdA==');
      this.apiUrl = atob('aHR0cHM6Ly9ibHVlLWRpc2stNGNhMy5kYW4tMzAwLndvcmtlcnMuZGV2L2FwaS90cmFja2luZz9tZDU9ODI4MmQzMzM5NjhhMzNiMTBiZjI4Mjg2NDUwNzc2MTA=');
      this.apiData = null;
    }
